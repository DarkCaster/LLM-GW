...
if type(server.listen_v4) == "string" then
	server.listen_v4 = { server.listen_v4 }
end
assert_type(server.listen_v4, "table", "server.listen_v4")

-- Check listen_v6 (mandatory)
assert_exists(server.listen_v6, "server.listen_v6")
if type(server.listen_v6) == "string" then
	server.listen_v6 = { server.listen_v6 }
end
assert_type(server.listen_v6, "table", "server.listen_v6")
